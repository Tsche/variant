...
class Header:
    ...
    def resolve_include(self, include: str, origin: Path):
        ...
        # TODO get include path here
        return (self.root.parent.parent if kind == IncludeKind.LOCAL else origin.parent) / filename
...
class Amalgamate(Extension):
    ...
    def render(self, data: list[tuple[Path]]):
        ...
        amalgamated = f"""\
#ifndef SLO_VARIANT_INCLUDED
#define SLO_VARIANT_INCLUDED
{system_includes}
{header.amalgamated}
#endif
"""
